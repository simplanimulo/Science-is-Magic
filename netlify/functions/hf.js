exports.handler = async (event) => {
  ...
  try {
    ...
    //const HF_URL = 'https://router.huggingface.co/hf-inference/models/gpt2-xl';
    const HF_URL = 'https://router.huggingface.co/hf-inference/models/deepseek-ai/DeepSeek-R1';
